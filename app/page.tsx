  ...
  return (
    <>
      ...
      <section className="tools" id="tools">
        <div className="container">
          ...
          <div className="tools-tabs reveal" style={{transitionDelay:".2s"}}>
            <button className="tool-tab active" onClick={() => { switchTool('takehome',this) }}>ð° Take-Home Pay</button>
            <button className="tool-tab" onClick={() => { switchTool('compare',this) }}>–ï¸ Sole Trader vs Ltd</button>
            <button className="tool-tab" onClick={() => { switchTool('vat',this) }}>ð VAT Checker</button>
            <button className="tool-tab" onClick={() => { switchTool('dividend',this) }}>ð¼ Dividend vs Salary</button>
          </div>
      ...
      <section className="awards-ticker">
        ...
        <div className="awards-ticker-outer">
          <div className="awards-ticker-row scroll-left">
            <div className="awards-ticker-card"><div className="awards-ticker-icon">ð</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">Fast-track Firm of the Year 2021</div><div className="awards-ticker-sub">Accounting Excellence</div></div><div className="awards-ticker-badge" style={{background:"#C8963E"}}>WINNER</div></div>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-grid">
            <div className="footer-brand"><a href="#" className="nav-logo" style={{color:"var(--white)"}}><div className="icon">M</div><span>Makesworth</span></a><p>Chartered accountants helping you keep more, grow faster, and worry less since 2012.</p><div className="footer-social"><a href="#">f</a><a href="#">ð</a><a href="#">ig</a><a href="#">in</a></div></div>
      ...
      <div style={{background:"#0a0a0a",borderTop:"1px solid #222",padding:"10px 20px",display:"flex",alignItems:"center",justifyContent:"center",gap:"0",flexWrap:"wrap",fontFamily:"-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif",fontSize:"11px",color:"#888"}}>
        ...
        <span style={{display:"flex",alignItems:"center",gap:"5px",padding:"0 12px",borderRight:"1px solid #333"}}>ð GDPR Privacy</span>
        <span style={{display:"flex",alignItems:"center",gap:"5px",padding:"0 12px",borderRight:"1px solid #333"}}>ð SSL Secured</span>
        <span style={{display:"flex",alignItems:"center",gap:"5px",padding:"0 12px",borderRight:"1px solid #333"}}>ð¡ï¸ CSP Protected</span>
        <span style={{display:"flex",alignItems:"center",gap:"5px",padding:"0 12px"}}>Built with <a href="https://websitegenerator.dev" target="_blank" rel="noopener" style={{color:"#888",textDecoration:"none",borderBottom:"1px solid #444",paddingBottom:"1px",transition:"color 0.2s"}} onMouseOver={() => { this.style.color='#fff' }} onMouseOut={() => { this.style.color='#888' }}>websitegenerator.dev</a></span>
      </div>
      ...
      <div className="walking-calcy" id="walkingCalcy" onClick={() => { toggleChat() }}>
        <div className="wc-speech" id="wcSpeech">ð¬ Need tax help? Click me!</div>
      ...
      <button className="chatbot-toggle" id="chatToggle" onClick={() => { toggleChat() }}>
        ...
        <div className="calcy-speech">ð¬ Ask me about UK tax!</div>
      ...
      <div className="chatbot" id="chatbot">
        ...
        <div className="calcy-area" id="calcyArea">
          <div className="calc-buddy" id="avatar">
            <div className="calc-body">
              <div className="calc-shell">
                ...
                <div className="calc-buttons" id="calcButtons">
                  ...
                  <div className="calc-btn num" data-val="7">7</div><div className="calc-btn num" data-val="8">8</div><div className="calc-btn num" data-val="9">9</div><div className="calc-btn op" data-val="Ã">Ã</div>
            ...
            <div className="calc-arm ar"><div className="arm-seg"></div><div className="calc-hand"></div></div>
            <div className="calc-legs"><div className="calc-legwrap"><div className="leg-seg"></div><div className="calc-shoe"></div></div><div className="calc-legwrap"><div className="leg-seg"></div><div className="calc-shoe"></div></div></div>
            <div className="floating-item f1">£</div><div className="floating-item f2">%</div><div className="floating-item f3">Σ</div><div className="floating-item f4">Ï</div><div className="floating-item f5">±</div>
            <div className="sparkle s1"></div><div className="sparkle s2"></div><div className="sparkle s3"></div>
            <div className="mood-badge" id="moodBadge">ð§® READY</div>
            <div className="platform-glow"></div>
          </div>
        </div>
        ...
        <div className="chatbot-msgs" id="chatMsgs">
          <div className="chat-msg bot">
            ð I'm <strong>Calcy</strong>! Tap a question or type your own for instant UK tax answers.
            <div className="chat-suggestions" style={{marginTop:"8px"}}>
              <span className="chat-sug" onClick={() => { askQ(0) }}>ð Self-assessment due?</span>
              <span className="chat-sug" onClick={() => { askQ(1) }}>ð· Personal allowance?</span>
              <span className="chat-sug" onClick={() => { askQ(2) }}>–ï¸ Sole trader vs Ltd?</span>
              <span className="chat-sug" onClick={() => { askQ(3) }}>ð VAT registration?</span>
              <span className="chat-sug" onClick={() => { askQ(4) }}>ð° Tax rates?</span>
              <span className="chat-sug" onClick={() => { askQ(5) }}>ð§¾ Dividend allowance?</span>
              <span className="chat-sug" onClick={() => { askQ(6) }}>ð  Work from home?</span>
              <span className="chat-sug" onClick={() => { askQ(7) }}>ð± Making Tax Digital?</span>
              <span className="chat-sug" onClick={() => { askQ(8) }}>ð Employer NI?</span>
              <span className="chat-sug" onClick={() => { askQ(9) }}>ð Student loan?</span>
            </div>
          </div>
        </div>
